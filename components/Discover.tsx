...
const Discover = () => {
  ...
  const activeTopicStyle =
    'xl:border-2 hover:bg-primary xl:border-secondary px-3 py-2 rounded xl:rounded-full flex item-center gap-2 justify-center cursor-pointer text-secondary';
  const topicStyle =
